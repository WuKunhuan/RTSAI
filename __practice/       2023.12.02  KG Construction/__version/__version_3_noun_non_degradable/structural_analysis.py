...
from structural_analysis_setting import NOUN_COMPOUND, NOUN_PHRASE_NON_DET_NON_DEGRADABLE, ADJECTIVE_PHRASE_NON_DEGRADABLE, PREPOSITION_PHRASE_NON_DEGRADABLE
...
## Display the grammar rules, translating the keys to values
