...
POS_key_str[f'{NOUN_PHRASE_NON_DET_NON_DEGRADABLE}'] = "NP"
...
POS_key_str[f'{NOUN_COMPOUND}'] = "NC" # "NP"
...
## Noun Phrase Non Degradable : cannot be simplified to noun compounds
Patterns_grammar_ENGLISH[f'{NOUN_PHRASE_NON_DET_NON_COMPOUND}'] = [
    item for item in Patterns_grammar_ENGLISH[f'{NOUN_PHRASE_NON_DET}'] if not start_with (item, f'{NOUN_COMPOUND}')
]
